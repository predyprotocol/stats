...
import { LP_REVENUE_DAILY_QUERY, LpRevenueDailies } from '../../queries/lpRevenueDailyQuery'

export function useLpRevenueDaily(start: number) {
  const { data, loading } = useQuery<LpRevenueDailies>(
