...
interface ApplyInterestLogicInterface extends ethers.utils.Interface {
  functions: {}
...
export class ApplyInterestLogic extends BaseContract {
  ...
  interface: ApplyInterestLogicInterface
