...
interface IUniswapV3PoolOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class IUniswapV3PoolOracle extends BaseContract {
  ...
  interface: IUniswapV3PoolOracleInterface
