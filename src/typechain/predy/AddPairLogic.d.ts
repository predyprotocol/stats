...
interface AddPairLogicInterface extends ethers.utils.Interface {
  functions: {}

  events: {
    'AssetRiskParamsUpdated(uint256,tuple)': EventFragment
    'IRMParamsUpdated(uint256,tuple,tuple)': EventFragment
    'PairAdded(uint256,uint256,address)': EventFragment
...
export class AddPairLogic extends BaseContract {
  ...
  filters: {
    ...
    'PairAdded(uint256,uint256,address)'(
      pairId?: null,
      pairGroupId?: null,
      _uniswapPool?: null
    ): TypedEventFilter<
      [BigNumber, BigNumber, string],
      { pairId: BigNumber; pairGroupId: BigNumber; _uniswapPool: string }
    >
