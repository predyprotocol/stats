...
interface IPredyTradeCallbackInterface extends ethers.utils.Interface {
  functions: {
...
export class IPredyTradeCallback extends BaseContract {
  ...
  interface: IPredyTradeCallbackInterface
